  ...
  return <div className={`app-shell theme-${themeMode}`}>
    ...
    <main className="workspace">
      ...
      <section className="content">
        ...
        {activeTab === 'storage' && <Storage API_URL={API_URL} authenticated={authenticated} />}
...
function Storage({ API_URL, authenticated }: any) {
  const fileInput = useRef<HTMLInputElement>(null);
  const [files, setFiles] = useState<any[]>([]), [directory, setDirectory] = useState(''), [loadingFiles, setLoadingFiles] = useState(true), [uploading, setUploading] = useState(false), [fileError, setFileError] = useState('');
